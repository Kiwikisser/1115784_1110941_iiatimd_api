...
class CoffeeSeeder extends Seeder
{
    ...
    public function run()
    {
      DB::table('coffees')->insert([
        ...
        'coffee_servings' => '180ml',
        'coffee_preptime' => '5 mins',
      ...
      DB::table('coffees')->insert([
        ...
        'coffee_bean' => 'Arabica',
        'coffee_servings' => '70ml',
        'coffee_preptime' => '1 min',
      ...
      DB::table('coffees')->insert([
        ...
        'coffee_bean' => 'Any',
        'coffee_servings' => '150ml',
        'coffee_preptime' => '10 mins',
      ...
      DB::table('coffees')->insert([
        ...
        'coffee_bean' => 'Any Espresso beans',
        'coffee_servings' => '100ml',
        'coffee_preptime' => '7 mins',
